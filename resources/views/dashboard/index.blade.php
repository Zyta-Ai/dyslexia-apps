...
<style>
    ...
    .story-banner-card, .game-card {
        background: linear-gradient(90deg, rgba(167, 222, 212, 0.7) 0%, rgba(123, 188, 174, 0.7) 100%);
    }

    .dongeng-button, .cta-button {
...
<div class="dashboard-background">
    <div class="main-content-container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex justify-between items-start mb-6">
            ...
            <a href="/login"
                class="logout-button px-4 py-2 rounded-lg font-bold shadow-md transition hover:opacity-90">
                Logout
            </a>
        </div>
            ...
            <div class="story-banner-content flex p-4">
                ...
                <div class="story-text flex-grow pt-3 text-dibi-text w-full md:w-3/5">
                    <p class="text-sm mb-3 leading-snug">
                        ...
                        advises, “Only a fool plants many seeds and refuses to allow them time to grow.” He returns to his palace, and, after knocking on the urn, a genie emerges offering three wishes...
                    </p>
