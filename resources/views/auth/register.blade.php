        ...
        <div class="w-full max-w-sm">
            ...
            <div class="bg-dibi-card p-8 rounded-xl shadow-2xl border-3 border-dibi-teal bg-opacity-95 card-register">
                ...
                <form method="POST" action="/register"> 
                    ...
                    <div class="mb-6">
                        <label for="password_confirmation" class="block text-dibi-text font-semibold mb-2">Konfirmasi Kata Sandi</label>
                    ...
                    <p class="text-center mt-4 text-dibi-text">
                        Sudah punya akun? <a href="/login" class="text-dibi-teal font-semibold hover:underline">Masuk di sini</a>
                    </p>
                </form>
            </div>
        </div>
